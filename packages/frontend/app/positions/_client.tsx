  ...
  return (
    <div className="pt-4">
      <header className="mb-10">
        <h1 className="display-title text-[56px] md:text-[72px] leading-none mb-3">my positions</h1>
        <p className="text-[16px] text-ink-soft max-w-[60ch]">
          your share balance + current usdc-denominated value. shares earn
          whatever extra yield the swarm captures across chains, minus 15%
          on extras only.
        </p>
      </header>
      ...
      {!isConnected && (
        <section className="frame-outer p-8 bg-paper-warm text-center" style={{ transform: "rotate(-0.4deg)" }}>
          <p className="text-[16px] text-ink mb-5">connect ur wallet to see ur shares.</p>
          ...
          <section className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
            <div className="frame-outer p-5">
              ...
              <p className="text-[12px] text-ink-faint">
                ...
                can move down if cross-chain LPs underperform.
              </p>
            </div>
            <div className="frame-outer p-5 bg-paper-warm">
              ...
              <p className="text-[14px] text-ink-soft mb-4">
                ...
                cross-chain unwind. cancellable after 24h if the agent stalls.
              </p>
